    ...
    <div class="modal-overlay">
      <div class="modal-container">
        <div class="modal-header">
          <h2 class="modal-title">Horario de atención</h2>
          <p class="modal-subtitle">Configura los horarios de atención</p>
        </div>
...
import ScheduleDayCard from '@/onboarding/components/schedule/schedule-day-card.component.vue'
